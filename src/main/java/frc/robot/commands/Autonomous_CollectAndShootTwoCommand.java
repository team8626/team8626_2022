 ...
 **/
public class Autonomous_CollectAndShootTwoCommand extends SequentialCommandGroup {
   ...
   */
  public Autonomous_CollectAndShootTwoCommand(double distanceMeters, DriveSubsystem drivetrain, IntakeSubsystem intake, StorageSubsystem storage, ShooterSubsystem shooter) {
